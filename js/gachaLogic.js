...
class gacha {
    ...
    { 
        ...
        for (let i=0; i<10; i++)
        {
            ...
            currentRoll.rateup = this.determineRateup (currentRoll.rollType, currentRoll.rollRarity, bannerSelect, gachaRates);
            currentRoll.outcome = this.determineRollOutcome (currentRoll.rollType, currentRoll.rollRarity, currentRoll.rateup, bannerSelect);
...
let bannerSelect = new bannerSelector ();
